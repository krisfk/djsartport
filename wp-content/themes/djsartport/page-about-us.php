...
<div class="course-detail-banner-div">
    ...
    <div class="course-detail-banner-div-3"
        style="background: url(http://143.198.107.5/wp-content/uploads/2024/05/artport-banner3-scaled.jpg) center center no-repeat; width: 50%; background-position: center; background-size: 100%;height:300px;">
    </div>
